...
public class BluetoothTerminal extends Activity {
	...
	private static final int VOICERECOGNITION = 5;
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.accelerometer:
			if (mChatService.getState() != BluetoothThread.STATE_CONNECTED) {
				...
				mChatService = null;
				mConversationArrayAdapter.clear();
				Intent accelerometerIntent = new Intent(this,
						AccelerometerControl.class);
				accelerometerIntent.putExtra("DeviceAddress", address);
				startActivityForResult(accelerometerIntent, ACCELEROMETER);
		...
		case R.id.voicerecognition:
			if (mChatService.getState() != BluetoothThread.STATE_CONNECTED) {
				...
				mChatService = null;
				mConversationArrayAdapter.clear();
				Intent voiceIntent = new Intent(this, VoiceRecognition.class);
				voiceIntent.putExtra("DeviceAddress", address);
				startActivityForResult(voiceIntent, VOICERECOGNITION);
				return true;
			}
		}
		return false;
